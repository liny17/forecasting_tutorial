...
There are two main libraries in R for forecasting. The first is the *sarima* library, which handles ARMA and ARIMA models for us, allowing us to set parameters easily.
